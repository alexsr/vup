...
vup::V_T_F_shader::V_T_F_shader(const filesystem::path& vertex_path,
        ...
        : Shader(introspection_flag), m_vertex_path(vertex_path), m_control_path(control_path),
          m_evaluation_path(evaluation_path), m_fragment_path(fragment_path) {
